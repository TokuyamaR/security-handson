...
!(function (e, t) {
  ...
  var v,
    ...
    x = R(String.prototype.replace),
    _ = R(String.prototype.indexOf),
  ...
  var re = (function t() {
    ...
    var ye,
      ...
      Se = Z,
      xe = null,
      _e = C({}, [].concat(a(I), a(F), a(U), a(H), a(P))),
      ke = null,
      ...
      dt = function (t) {
        (ft && ft === t) ||
          ...
          (xe = "ALLOWED_TAGS" in t ? C({}, t.ALLOWED_TAGS, ge) : _e),
          ...
          Ve &&
            ((xe = C({}, a(P))),
            (ke = []),
            !0 === Ve.html && (C(xe, I), C(ke, B)),
            !0 === Ve.svg && (C(xe, F), C(ke, G), C(ke, q)),
            !0 === Ve.svgFilters && (C(xe, U), C(ke, G), C(ke, q)),
            !0 === Ve.mathMl && (C(xe, H), C(ke, W), C(ke, q))),
          t.ADD_TAGS && (xe === _e && (xe = L(xe)), C(xe, t.ADD_TAGS, ge)),
          ...
          $e && (xe["#text"] = !0),
          ze && C(xe, ["html", "head", "body"]),
          xe.table && (C(xe, ["tbody"]), delete Re.tbody),
          p && p(t),
          (ft = t));
      },
    ...
    var Tt = function (e) {
      ...
      kt = function (e) {
        var t;
        if ((_t("beforeSanitizeElements", e, null), St(e))) return Nt(e), !0;
        var n = ge(e.nodeName);
        if (
          (_t("uponSanitizeElement", e, { tagName: n, allowedTags: xe }),
          e.hasChildNodes() &&
      ...
      Rt = function (t) {
        var n, o, a, i;
        _t("beforeSanitizeAttributes", t, null);
        var l = t.attributes;
        if (l) {
          var c = {
            attrName: "",
          ...
          _t("afterSanitizeAttributes", t, null);
        }
      },
      Ct = function e(t) {
        var n,
          r = wt(t);
        for (_t("beforeSanitizeShadowDOM", t, null); (n = r.nextNode()); )
    ...
    return (
      (r.sanitize = function (e) {
        ...
        if (
          ((it = !e) && (e = "\x3c!--\x3e"), "string" != typeof e && !xt(e))
        ) {
